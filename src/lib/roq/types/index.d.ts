...
export namespace Prisma {
  ...
  */
  ...
  interface payrollFieldRefs {
    ...
    readonly insurance: FieldRef<'payroll', 'Int'>;
    readonly other_deductions: FieldRef<'payroll', 'Int'>;
  ...
  export type payrollWhereInput = {
    ...
    insurance?: IntFilter<'payroll'> | number;
    other_deductions?: IntFilter<'payroll'> | number;
  ...
  export type payrollScalarWhereWithAggregatesInput = {
    ...
    insurance?: IntWithAggregatesFilter<'payroll'> | number;
    other_deductions?: IntWithAggregatesFilter<'payroll'> | number;
  ...
  export type payrollUpdateInput = {
    ...
    other_deductions?: IntFieldUpdateOperationsInput | number;

  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash the power of efficient management with HR Information System - your one-stop solution for employee data, vacations, and payroll."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of efficient management with HR Information System - your one-stop solution for employee data, vacations, and payroll.`}
            </Text>
            <Box
